...
<head>
    ...
    <meta name="description" content="Portfolio Johanna Penet" />
    ...
    <main class="flex-shrink-0">
        ...
        <nav class="navbar navbar-expand-lg navbar-light bg-white py-3">
            <div class="container px-5">
                <a class="navbar-brand" href="index"><span class="fw-bolder text-primary">Johanna Pénet</span></a>
        ...
        <footer class="bg-white py-4 mt-auto">
            <div class="container px-5">
                <div class="row align-items-center justify-content-between flex-column flex-sm-row">
                    <div class="col-auto">
                        <div class="small m-0">Copyright &copy; Portfolio Johanna Pénet 2023</div>
                    </div>
                    <div class="col-auto">
